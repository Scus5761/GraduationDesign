package com.hyphenate.graduationdesignchat.domain;
...
public class EmojiconExampleGroupData {
    ...
    private static EaseEmojiconGroupEntity createData(){
        ...
        for(int i = 0; i < icons.length; i++){
            ...
            datas[i].setName(ChatApplication.getInstance().getApplicationContext().getString(R.string.emojicon_test_name)+ (i+1));
