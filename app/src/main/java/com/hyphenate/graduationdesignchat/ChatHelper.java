...
import com.hyphenate.graduationdesignchat.conference.ConferenceActivity;
import com.hyphenate.graduationdesignchat.db.DemoDBManager;
import com.hyphenate.graduationdesignchat.db.InviteMessgeDao;
import com.hyphenate.graduationdesignchat.db.UserDao;
import com.hyphenate.graduationdesignchat.domain.EmojiconExampleGroupData;
import com.hyphenate.graduationdesignchat.domain.InviteMessage;
import com.hyphenate.graduationdesignchat.domain.InviteMessage.InviteMessageStatus;
import com.hyphenate.graduationdesignchat.domain.RobotUser;
import com.hyphenate.graduationdesignchat.parse.UserProfileManager;
import com.hyphenate.graduationdesignchat.receiver.CallReceiver;
import com.hyphenate.graduationdesignchat.ui.ChatActivity;
import com.hyphenate.graduationdesignchat.ui.MainActivity;
import com.hyphenate.graduationdesignchat.ui.VideoCallActivity;
import com.hyphenate.graduationdesignchat.ui.VoiceCallActivity;
import com.hyphenate.graduationdesignchat.utils.PreferenceManager;
...
//                break;
    ...
    * 当它锁定一个方法或者一个代码块的时候，
    * 同一时刻最多只有一个线程执行这段代码。
    * 当两个并发线程访问同一个对象object中的这个加锁同步代码块时，
    * 一个时间内只能有一个线程得到执行。
